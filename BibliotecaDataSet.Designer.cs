...
namespace Biblioteca {
    ...
    public partial class BibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class LibrosDataTable : global::System.Data.TypedTableBase<LibrosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LibrosRow AddLibrosRow(string titulo, string autor, int año) {
...
namespace Biblioteca.BibliotecaDataSetTableAdapters {
    ...
    public partial class LibrosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Libros] WHERE (([id] = @Original_id) AND ((@IsNull_titulo = 1 AND [titulo] IS NULL) OR ([titulo] = @Original_titulo)) AND ((@IsNull_autor = 1 AND [autor] IS NULL) OR ([autor] = @Original_autor)) AND ((@IsNull_año = 1 AND [año] IS NULL) OR ([año] = @Original_año)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Libros] ([titulo], [autor], [año]) VALUES (@titulo, @autor, @a" +
                "ño);\r\nSELECT id, titulo, autor, año FROM Libros WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Libros] SET [titulo] = @titulo, [autor] = @autor, [año] = @año WHERE (([id] = @Original_id) AND ((@IsNull_titulo = 1 AND [titulo] IS NULL) OR ([titulo] = @Original_titulo)) AND ((@IsNull_autor = 1 AND [autor] IS NULL) OR ([autor] = @Original_autor)) AND ((@IsNull_año = 1 AND [año] IS NULL) OR ([año] = @Original_año)));
SELECT id, titulo, autor, año FROM Libros WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, titulo, autor, año FROM dbo.Libros";
        ...
        public virtual int Delete(int Original_id, string Original_titulo, string Original_autor, global::System.Nullable<int> Original_año) {
        ...
        public virtual int Insert(string titulo, string autor, global::System.Nullable<int> año) {
            if ((titulo == null)) {
        ...
        public virtual int Update(string titulo, string autor, global::System.Nullable<int> año, int Original_id, string Original_titulo, string Original_autor, global::System.Nullable<int> Original_año, int id) {
            if ((titulo == null)) {
            ...
            if ((Original_año.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_año.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string titulo, string autor, global::System.Nullable<int> año, int Original_id, string Original_titulo, string Original_autor, global::System.Nullable<int> Original_año) {
            return this.Update(titulo, autor, año, Original_id, Original_titulo, Original_autor, Original_año, Original_id);
        }
    }
